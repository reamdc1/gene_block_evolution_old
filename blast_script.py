...
def parser_code():
    ...
    parser.add_argument("-o", "--outfolder", dest="outfolder", metavar="FOLDER", default='',
...
def check_options(parsed_args):
    ...
    if os.path.isdir(parsed_args.database_folder):
        ...
        print "The folder %s does not exist." % parsed_args.database_folder
        sys.exit()
    ...
    return database_folder, outfolder, filter_file, num_proc, query_file, e_val
...
def main():
    ...
    database_folder, outfolder, filter_file, num_proc, query_file, e_val = check_options(parsed_args)
    ...
    # ./blast_script.py -d ./db/ -o ./blast_result/ -q ./operon_query.fa 
